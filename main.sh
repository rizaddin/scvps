...
CDNF="https://raw.githubusercontent.com/rizaddin/scvps"
...
function pasang_ssl() {
   ...
   # STOPWEBSERVER=$(lsof -i:80 | cut -d' ' -f1 | awk 'NR==2 {print $1}')
    ...
    ~/.acme.sh/acme.sh --installcert -d $domain --fullchainpath /etc/xray/xray.crt --keypath /etc/xray/newbie.pem --ecc
